...
public class ChildController extends BaseController {
    ...
    public StandardResponse add(@RequestBody ChildAddRequest request) {
        ...
        return childService.add(sessionInfo, request.getChildInfo(), request.getCourseSchedulingInfos());
    }
    ...
    public StandardResponse update(@RequestBody ChildUpdateRequest request) {
        SessionInfo sessionInfo = getCurrentSession();
        return childService.update(sessionInfo, request.getChildInfo(), request.getCourseSchedulingInfos());
    }
